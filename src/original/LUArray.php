...
class LUArray
{
     ...
     * @return bool
     */
    public function has_contain( array $array, $needle, bool $is_strict=false ): bool
    {
     ...
     * @return bool
     */
    public function has_mutual_contain( array $array, $needle, bool $is_strict=false ): bool
    {
        foreach ($array as $value) {
            if ( $is_strict ) {
