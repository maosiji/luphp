...
use DateTime;
use MAOSIJI\LU\EXCEPTION\LUBaseException;
use MAOSIJI\LU\EXCEPTION\LUIdcardException;
...
class LUIdcard
{
     ...
     * @throws LUIdcardException 身份证号码无效时抛出
     */
    public function sex(string $idcard): int
    {
        if ( !$this->is($idcard) ) {
            throw new LUIdcardException(
                '身份证号码无效，无法获取性别',
                LUIdcardException::CODE_INVALID_IDCARD,
                null,
                $idcard
            );
        }
