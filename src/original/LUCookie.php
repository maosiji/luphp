...
class LUCookie {
     ...
     * @return bool
     */
    public function set( string $key, string $value, int $expire_seconds=300 ): bool
    {
     ...
     * @return bool
     */
    public function check( string $key, string $value, bool $is_delete=false ): bool
    {
     ...
     * @return string
     */
    private function _encode_data( array $data ): string
    {
